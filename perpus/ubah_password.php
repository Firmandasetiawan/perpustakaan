...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_POST['old_password']) && isset($_POST['password'])) {
        ...
        $error = "Password lama dan/atau password baru tidak diterima.";
    }
}
?>
    ...
    <section class="content">
        <div class="container">
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                ...
                <input type="submit" value="Update"> | <button onclick="location.href='profil.php';" style="margin-bottom: 20px;" >kembali</button>
