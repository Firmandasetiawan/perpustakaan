...
<header class="header">
    ...
    <img src="img/buku1.png" alt="image" class="book-img">
        ...
        <nav class="navbar">
        <ul class="nav-menu">
                <li class="nav-item"><a href="petugas_dashboard.php">Dashboard</a></li>
                <li class="nav-item"><a href="tampil_pinjam1.php">Peminjaman</a></li>
                <li class="nav-item"><a href="tampil_ulasan1.php">Ulasan</a></li>
                <li class="nav-item"><a href="buku1.php">Pendataan Buku</a></li>
                <li class="nav-item"><a href="laporan1.php">Laporan</a></li>
