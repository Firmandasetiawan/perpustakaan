...
<header class="header">
    ...
    <img src="img/buku1.png" alt="image" class="book-img">
        ...
        <nav class="navbar">
            <ul class="nav-menu">
                <li class="nav-item"><a href="peminjam_dashboard.php">Dashboard</a></li>
                <li class="nav-item"><a href="tampil_pinjam2.php">Peminjaman</a></li>
                <li class="nav-item"><a href="tampil_ulasan2.php">Ulasan</a></li>
