                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        while($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<td><a href='verifikasi_kembali1.php?id=" . $row['peminjamanid'] . "'><button>Kembalikan</button></a></td>";
                                            echo "<td><a href='edit_pinjam1.php?id=" . $row['peminjamanid'] . "'><button>Edit</button></a> |
                                                <a href='hapus_pinjam1.php?id=" . $row['peminjamanid'] . "' onclick='return confirm(\"Apakah Anda yakin ingin menghapus peminjaman ini?\")'>
                                                    <button>Hapus</button>
                                                </a>
                                                </td>";
